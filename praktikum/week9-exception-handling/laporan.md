...
## Dasar Teori
Dalam Java, kesalahan dibedakan menjadi error dan exception, di mana error merupakan kesalahan fatal pada sistem yang tidak dapat ditangani oleh program dan biasanya menyebabkan aplikasi berhenti, sedangkan exception adalah kondisi kesalahan yang terjadi saat program berjalan namun masih dapat ditangani menggunakan mekanisme try–catch–finally sehingga program tetap dapat berjalan dengan baik.
